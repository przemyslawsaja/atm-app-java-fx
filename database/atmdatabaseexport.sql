...
INSERT INTO `atm_card` VALUES (987621312,'d5f12e53a182c062b6bf30c1445153faff12269a',338,'debetowa','11114015601081110181488249');
...
INSERT INTO `bank_account` VALUES ('11114015601081110181488249','dla studentow',1015,1);
...
CREATE TABLE `operation_history` (
  ...
  KEY `account_number` (`account_number`),
  CONSTRAINT `operation_history_ibfk_1` FOREIGN KEY (`account_number`) REFERENCES `bank_account` (`account_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-02 18:31:09
